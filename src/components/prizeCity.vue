<template>
  <div class="prizeCity">
    <Header title="长影平台" :isShow="true">
      <span slot="right">
        <!-- <div class="heart"> -->
          <img src="../assets/img/heart.png" alt="" @click.stop='$router.push({name:"heart"})'>
          <img @click.stop='$router.push({name:"orderLsit"})' src="../assets/img/order.png" alt="">
        <!-- </div> -->
    ...
    <div class="index_banner_1">
      ...
      <swiper :list="bannerData" auto height="328px" dots-class="custom-bottom" dots-position="center"></swiper>
      <div class="box">
    ...
    methods: {
      async getList() {
        try {
          const {
            data
          } = await getAllProductApi.getList({
            id: 0
          })
          this.goods = data
        } catch (err) {
...
.list-goods{
  ...
  .list_item {
    ...
    width: 50%;
    // margin-left: 12px;
>>>>>>> 615a9bb180ad73ed46a77d5a2e05bc0297a47665
    display: inline-block;
    margin-right: 0.26667rem;
    width: 230px;
  }
...
<<<<<<< HEAD
  ...
  .shop_item_3_img::after {
    ...
    bottom: 20px;
    right: -13px;
    border-right: 2px solid #282828; // transform: scaleX(0.5);
    transform-origin: 100% 100%;
  }
  .shop_item_3:last-child {
    .shop_item_3_img::after {
    ...
    .list_content {
      ...
      .list_item {
        ...
        .list_item_title {
          ...
          font-size: 24px;
          color: rgb(51, 51, 51);
          padding: 15px 0px; // border-bottom: 1px solid rgb(230, 230, 230);
          overflow: hidden;
          text-overflow: ellipsis;
          word-break: break-all;
          display: -webkit-box;
