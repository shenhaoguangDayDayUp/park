  ...
  .order-list {
    ...
    .order-content {
      ...
      .content-title::after {
        ...
        right: 0px;
        left: 0px;
        border-bottom: 2px solid #323540; // border-right: 2px solid #282828;
